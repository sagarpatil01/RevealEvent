...
export default function LoginComp()
{
    ...
    const loggedOrganizerId = localStorage.getItem("loggedOrganizer");
    console.log(loggedOrganizerId)
    console.log(localStorage.getItem("loggedOrganizer"));
        ...
        .then(obj => {
                       ...
                       
                       {
                        ...
                        if(obj.status === false)
                        {
                            ...
                            {
                                // alert("organizer");
                                console.log(obj.utype.id)
                               localStorage.setItem("loggedOrganizer", obj.utype.id);
                                navigate("/organizer_home");

                            }else if(obj.utype.id  === 3)
                            {
                                // alert("artist")
                                localStorage.setItem("loggedArtist", obj.utype.id);
    ...
    return(
        <div>
         ...
         <br/>
         <b><a href='/register' className='reg-link' style={{color:'black'}}> New here ? <span style={{color:'yellow'}}>REGISTER</span> now</a></b>
        ...
        <div className="container " >
            <form>
                <div className="mb-3">
                    ...
                    onChange={(e)=>{dispatch({type:'update',fld:'username',val:e.target.value})}} required ></input>
                ...
                <div className="mb-3">
                     ...
                     onChange={(e)=>{dispatch({type:'update',fld:'password',val:e.target.value})}} required ></input>
