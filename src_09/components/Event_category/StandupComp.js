...
export default function StandupComp(){
    ...
    const loadData = async () => {
      ...
      await fetch("http://localhost:8080/geteventname?genre_cat_id="+5)
      .then(res => res.json())
      ...
      return(
            ...
            <div>
              <CustNavComp/>
                ...
                {/* {c.event_name} */} Zakir Khan Show
                </Typography>
                <Typography variant="body2" color="text.secondary">
                {/* {c.description} */} After a massively successful special Tathastu, Zakir Khan is on the road with his new show!
                </Typography>
                </CardContent>
                </CardActionArea>
               </Card> 
