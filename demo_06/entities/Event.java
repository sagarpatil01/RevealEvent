...
public class Event {
	...
	private float price;
	@Column
	private String img_landscape;
	@Column
	private String img_potrait;
	...
	public Event(int id, String event_name, String description, Date event_date, String duration, float price,
			String img_landscape, String img_potrait, Genre_category genre_cat_id, Venue venue_id,
			Organizer organiser_id) {
		super();
		this.id = id;
	...
	public Event(String event_name, String description, Date event_date, String duration, float price,
			Genre_category genre_cat_id, Venue venue_id, Organizer organiser_id) {
		super();
		this.event_name = event_name;
		this.description = description;
	...
	public String getImg_landscape() {
		return img_landscape;
	}



	public void setImg_landscape(String img_landscape) {
		this.img_landscape = img_landscape;
	}



	public String getImg_potrait() {
		return img_potrait;
	}



	public void setImg_potrait(String img_potrait) {
		this.img_potrait = img_potrait;
	}
