...
using AdminRestAPI.Models;

namespace AdminRestAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OrganizersController : ControllerBase
    {
        private readonly RevealeventContext _context;

        public OrganizersController(RevealeventContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Organizer>> PostOrganizer(Organizer organizer)
        {
          if (_context.Organizers == null)
          {
              return Problem("Entity set 'RevealeventContext.Organizers'  is null.");
          }
