...
CREATE TABLE `artist_request` (
  ...
  PRIMARY KEY (`id`),
  KEY `organizer_id_fk_idx` (`org_id`),
  KEY `artist_id_fk_idx` (`art_id`),
  CONSTRAINT `artist_fk` FOREIGN KEY (`art_id`) REFERENCES `artist` (`id`),
  CONSTRAINT `organizer_fk` FOREIGN KEY (`org_id`) REFERENCES `organizer` (`id`)
...
INSERT INTO `artist_request` VALUES (2,1,1,0),(4,1,2,0);
...
INSERT INTO `customer` VALUES (1,'manish','samant','samant@gmail.com','684457956','1999-01-08','m','single','kokan',2),(6,'Sagar','Patil','patilsagar@gmail.com','78513357952','1997-08-15','m','single','Kolhapur',7),(7,'Mahindra','Meena','mm@gmail.com','879545462','2023-08-31','','single','Rajhstan',9);
...
INSERT INTO `login` VALUES (1,'rohit166','Rohit@123',NULL,2),(2,'manish778','Manish@123',NULL,1),(3,'zakir123','khan@123',NULL,3),(4,'mahesh123','kale@123',NULL,3),(5,'akash123','gupta@123',NULL,3),(6,'mahesh222','gupta@222',NULL,2),(7,'Sagar@genius','Sagar@123',NULL,NULL),(8,'Yohan@Toper','Yohan@123',NULL,3),(9,'Mahindra','Mahi@123',NULL,1);
...
INSERT INTO `organizer` VALUES (1,'Rohit Enterprises','4785s5','mehrarohit@gmail.com','8954756277',NULL),(2,'Mahesh Enterprises','4552154','guptamahesh@gmail.com','4758545145',NULL);
...
-- Dump completed on 2023-08-26 22:56:23
